...
INSERT INTO wcommand([wmenu_id], [wmenu_id0], [menu_id], [bar], [bar2], [link], [parameter], [icon_url], [width], [status], [icon], [expl_icon], [sysid], [edition], [datetime2], [datetime0], [user_id0], [user_id2], [type], [syscode], [msys], [target], [xtype], [smenu_id], [sicon]) VALUES(N'01.40.02', N'01.40.00', N'99.50.03', N'Khai báo quyền chức năng', N'Defining Task Access Control', N'crmAllowTabRight.aspx', N'', N'', 0, N'1', N'', 0, N'crmAllowTabRight', N'', NULL, NULL, 0, 0, N'D', N'', 0, N'', N'00', N'', N'')
INSERT INTO wcommand([wmenu_id], [wmenu_id0], [menu_id], [bar], [bar2], [link], [parameter], [icon_url], [width], [status], [icon], [expl_icon], [sysid], [edition], [datetime2], [datetime0], [user_id0], [user_id2], [type], [syscode], [msys], [target], [xtype], [smenu_id], [sicon]) VALUES(N'01.40.03', N'01.40.00', N'99.50.05', N'Khai báo quyền bộ phận', N'Defining Department Access Control', N'crmAllowDepartmentRight.aspx', N'', N'', 0, N'1', N'', 0, N'crmAllowDepartmentRight', N'', NULL, NULL, 0, 0, N'D', N'', 0, N'', N'00', N'', N'')
...
INSERT INTO wcommand([wmenu_id], [wmenu_id0], [menu_id], [bar], [bar2], [link], [parameter], [icon_url], [width], [status], [icon], [expl_icon], [sysid], [edition], [datetime2], [datetime0], [user_id0], [user_id2], [type], [syscode], [msys], [target], [xtype], [smenu_id], [sicon]) VALUES(N'39.05.02', N'39.00.00', N'39.05.02', N'Danh mục bộ phận theo NVBH', N'Department List', N'crmDepartment.aspx', N'', N'', 0, N'1', N'', 0, N'crmDepartment', N'', NULL, NULL, 0, 0, N'D', N'', 0, N'', N'00', N'', N'')
GO
...
INSERT INTO command([menu_id], [menu_id0], [bar], [bar2], [type], [exe], [rep_file], [title], [title2], [web_menu], [web_doc], [icon], [expl_icon], [sysid], [rep_form], [syscode], [hide_yn], [password], [expl_id], [expl_id0], [msys], [xtop], [xleft], [sbar], [sbar2], [vc_active], [mbar], [mbar2], [nbar], [nbar2], [nicon], [ntop], [nleft], [ngroup], [ngroupicon], [npopupicon], [ndesc], [ndesc2], [edition], [datetime2], [datetime0], [user_id0], [user_id2]) VALUES(N'39.05.02', N'99.00.00', N'Danh mục bộ phận', N'Department List', N'', N'crmDepartment.aspx', N'', N'', N'', 0, N'', N'', 0, N'crmDepartment', N'', N'', 0, 0, N'', N'', 0, 0.00, 0.00, N'', N'', N'', N'', N'', N'', N'', N'', 0.00, 0.00, N'', N'', N'', N'', N'', N'', NULL, NULL, 0, 0)
GO
